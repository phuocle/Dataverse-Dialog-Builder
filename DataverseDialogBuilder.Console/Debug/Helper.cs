...
namespace DataverseDialogBuilder.Console.Debug
{
    public static class Helper
    {
        public static RemoteExecutionContext GetCustomActionExecutionContext
        {
            get
            {
                var RemoteExecutionContext = new RemoteExecutionContext
                {
                    MessageName = "pl_DataverseDialogBuilder",
                    Stage = 40,
                    Mode = 0,
        ...
        {
            var pluginExecutionContext = ConvertJsonToRemoteExecutionContext(json);
            return GetServiceProvider(pluginExecutionContext, service);
        }

        public static IServiceProvider GetServiceProvider(RemoteExecutionContext pluginExecutionContext, CrmServiceClient service)
        {
        ...
        public static RemoteExecutionContext ConvertJsonToRemoteExecutionContext(string json)
        {
